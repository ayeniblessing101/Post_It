    ...
    value: function handleSubmit(event) {
      ...
      if (this.isValid()) {
        ...
        if (this.state.newPassword === this.state.confirmNewPassword) {
          this.props.resetPassword(this.state.newPassword, this.state.confirmPassword, email).then(function () {
...
//# sourceMappingURL=0.00bc1941e6215641e122.hot-update.js.map