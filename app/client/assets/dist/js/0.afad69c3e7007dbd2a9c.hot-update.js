    ...
    value: function handleSubmit(event) {
      ...
      if (this.isValid()) {
        ...
        if (this.state.newPassword === this.state.confirmNewPassword) {
          this.props.resetPassword(this.state.newPassword, this.state.onfirmPassword, email).then(function () {
...
//# sourceMappingURL=0.afad69c3e7007dbd2a9c.hot-update.js.map