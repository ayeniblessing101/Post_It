...
GroupsPage.propTypes = {
  ...
  groups: _propTypes2.default.shape({
    ...
    allGroups: _propTypes2.default.array.isRequired
  })
};
...
var AddUserModal = function (_React$Component) {
  ...
  _createClass(AddUserModal, [{
    key: 'isValid',
    value: function isValid() {
      var _validateAddUserInput = (0, _validation.validateAddUserInput)(this.state),
          errors = _validateAddUserInput.errors,
          isValid = _validateAddUserInput.isValid;
...
var ForgetPasswordModal = function (_React$Component) {
  ...
  _createClass(ForgetPasswordModal, [{
    key: 'isValid',
    value: function isValid() {
      var _validateForgotPasswo = (0, _validation.validateForgotPasswordInput)(this.state),
          errors = _validateForgotPasswo.errors,
          isValid = _validateForgotPasswo.isValid,
          email = _validateForgotPasswo.email,
          addFlashMessage = _validateForgotPasswo.addFlashMessage;
...
var LoginForm = function (_React$Component) {
  ...
  _createClass(LoginForm, [{
    key: 'isValid',
    value: function isValid() {
      var _validateLoginInput = (0, _validation.validateLoginInput)(this.state),
...
var ResetPasswordForm = function (_React$Component) {
  ...
  _createClass(ResetPasswordForm, [{
    key: 'isValid',
    value: function isValid() {
      var _validateResetPasswor = (0, _validation.validateResetPasswordInput)(this.state),
          errors = _validateResetPasswor.errors,
          isValid = _validateResetPasswor.isValid;
...
var SignupForm = function (_React$Component) {
  ...
  _createClass(SignupForm, [{
    ...
    key: 'isValid',
    value: function isValid() {
      var _validateSignUpInput = (0, _validation.validateSignUpInput)(this.state),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                totalCount > 5 && _react2.default.createElement(_reactPaginate2.default, {
                  previousLabel: 'previous',
                  nextLabel: 'next',
                  breakLabel: _react2.default.createElement(
                    'a',
...
module.exports = {
  ...
  */
  validateSignUpInput: function validateSignUpInput(inputData) {
    var errors = {};
    ...
    if (!(0, _numberValidation2.default)(inputData.phoneNo)) {
    ...
    if (_validator2.default.isEmpty(inputData.confirm_password)) {
      errors.confirm_password = 'This field required';
    }
    if (!_validator2.default.equals(inputData.password, inputData.confirm_password)) {
  ...
  /**
    ...
    * @returns {errors} - returns errors.
  */
  validateLoginInput: function validateLoginInput(inputData) {
    var errors = {};
    if (_validator2.default.isEmpty(inputData.username)) {
  ...
  /**
    ...
    * @returns {errors} - returns errors.
  */
  validateAddUserInput: function validateAddUserInput(inputData) {
    var errors = {};
    if (_validator2.default.isEmpty(inputData.username)) {
      errors.username = 'This field is required';
    }
  ...
  /**
    ...
    * @returns {errors} - returns errors.
  */
  validateAddGroupInput: function validateAddGroupInput(inputData) {
    var errors = {};
  ...
  /**
    ...
    * @returns {errors} - returns errors.
  */
  validateForgotPasswordInput: function validateForgotPasswordInput(inputData) {
    var errors = {};
    if (_validator2.default.isEmpty(inputData.email)) {
  ...
  * @returns {errors} - returns errors.
  */
  validateResetPasswordInput: function validateResetPasswordInput(inputData) {
    var errors = {};
    if (_validator2.default.isEmpty(inputData.newPassword)) {
      errors.newPassword = 'This field is required';
    }
    if (_validator2.default.isEmpty(inputData.confirmNewPassword)) {
...
//# sourceMappingURL=0.d0643c2838948c35b880.hot-update.js.map