...
var AddGroupForm = exports.AddGroupForm = function (_React$Component) {
  ...
  _createClass(AddGroupForm, [{
    ...
    value: function uploadFile(files) {
      ...
      var url = 'https://api.cloudinary.com/v1_1/' + cloudName + '/image';
      ...
      var uploadRequest = _axios2.default.post(url);
      ...
      uploadRequest.end(function (error, response) {
        ...
        var images = Object.assign([], _this3.state.images);
...
//# sourceMappingURL=0.01a350b19e897432d352.hot-update.js.map